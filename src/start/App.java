...
public class App {
    ...
    public static void main(String[] args) {
        boolean check3=true;
        while(check3==true){
        System.out.println("Καλησπέρα σας,έχετε ήδη λογαριασμό;/nΑν ΝΑΙ πληκτρολογήστε ΝΑΙ ,διαφορετικά ΟΧΙ");
        ...
        if(x.equals("ΝΑΙ")) {
            ...
            while(!(u.users.containsKey(username) && u.users.get(username).equals(password))) {
                System.out.println("Λάθος κωδικός  ή όνομα χρήστη,θέλετε να ξαναπροσπαθήσετε;/n ΝΑΙ 'Η ΟΧΙ");
                x=input.next();
            ...
            System.out.println("Θα θέλατε να εγγραφείτε;/n ΝΑΙ 'Η ΟΧΙ");
            x = input.next();
            if (x.equals("ΟΧΙ")) System.exit(0);
            ...
            System.out.println("Password:");
            String password = input.next();
            System.out.println("Τύποσ Λογαριασμού:");
            ...
            do {
                ...
                {
                    if ((ονομα.isEmpty() || επιθετο.isEmpty() || username.isEmpty() || password.isEmpty() || type.isEmpty())&& check2) {
